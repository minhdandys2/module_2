    ...
    <div class="info-side">
        <div class="today-info-container">
            <div class="today-info">
                <div class="precipitation"> <span class="title">WIND</span><span class="value">{{$weather->wind->speed}} km/h</span>
                    <div class="clear"></div>
                </div>
